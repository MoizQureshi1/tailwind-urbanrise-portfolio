...
export default function Aboutpage (){
    return(
        <main className=" bg-white text-black  max-w-screen-2xl mx-auto">
            <div className="flex flex-col items-center md:flex-row md:justify-around pt-24 mr-16 ml-10 pb-20 mx-14">
                <Image src={fourpic} alt="fourPic" width={500} height={300} className="ml-6"/>
                <div className="pl-10 text-center md:text-start">
                    ...
                    <div className="flex justify-between mr-16 mt-8 ml-16 md:ml-1">
                        <div>
                            <h2 className="text-3xl font-bold md:text-start">600+</h2>
                            <p className="text-gray-600">Worked With 600+ <br/>Companies</p>
                        </div>
                        <div>
                            <h2 className="text-3xl font-bold mx-4">800+</h2>
