        ...
        <section className="bg-stone-800  max-w-screen-2xl mx-auto">
            <div className="flex flex-col items-center md:flex-row md:justify-around md:mr-24 text-white">
                <div className="pt-32 md:p-20 text-center sm:text-start px-8">
                    ...
                    <a href="/contact"><button className="border-2 border-yellow-600 p-2 pr-12 pl-12 text-black font-semibold bg-yellow-500 hover:bg-stone-800 hover:text-white ml-7 md:ml-0 mt-10">Contect Us</button></a>
                ...
                <Image src={boypic} alt="Boypic" width={300} className="my-16"/>
            </div>
            <Footer/>
        </section>
    )
