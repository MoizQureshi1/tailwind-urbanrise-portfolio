    ...
    return(
        <section className=" bg-white text-black max-w-screen-2xl mx-auto">
            <div className="pt-16 pb-24">
                ...
                <div className="flex flex-col items-center text-center md:text-start md:flex-row md:justify-around mt-20">
                    <div className="md:ml-20 mr-5">
